...
function AgeStripe() {
  return (
    <div className="age-stripe">
      Made for women in their <span style={{ color: "var(--orange-500)", fontWeight: 700 }}>30s</span>  because your hair loss has a different cause now than it did at 22.
    </div>);
                ...
                <div className={`timeline-beat${isFinal ? " final" : ""}${heavy ? " heavy" : ""}`}>
                  ...
                  {r.note && (
                    <div className="timeline-marginalia">
                      <Hand size={16} color={r.noteColor} rotate={r.noteRotate}>↘ {r.note}</Hand>
                    </div>
                  )}
                </div>
              </Reveal>
