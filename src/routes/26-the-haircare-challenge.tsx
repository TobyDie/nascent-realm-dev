...
import { ListiclePageV26 } from "@/features/haircare-challenge-v26/ListiclePageV26";

export const Route = createFileRoute("/26-the-haircare-challenge")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://glow.hairqare.co/26-the-haircare-challenge" },
      ...
      { name: "twitter:url", content: "https://glow.hairqare.co/26-the-haircare-challenge" },
    ],
    links: [
      { rel: "canonical", href: "https://glow.hairqare.co/26-the-haircare-challenge" },
