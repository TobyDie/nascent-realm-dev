...
import { ListiclePageV30 } from "@/features/haircare-challenge-v30/ListiclePageV30";

export const Route = createFileRoute("/30-the-haircare-challenge")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://glow.hairqare.co/30-the-haircare-challenge" },
      ...
      { name: "twitter:url", content: "https://glow.hairqare.co/30-the-haircare-challenge" },
    ],
    links: [
      { rel: "canonical", href: "https://glow.hairqare.co/30-the-haircare-challenge" },
