...
import { HaircareChallengePageV23 } from "@/features/haircare-challenge-v23/HaircareChallengePageV23";

const HERO_SIZES = "(max-width: 720px) 100vw, (max-width: 860px) 90vw, 405px";

export const Route = createFileRoute("/23-the-haircare-challenge")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://glow.hairqare.co/23-the-haircare-challenge" },
      ...
      { name: "twitter:url", content: "https://glow.hairqare.co/23-the-haircare-challenge" },
    ],
    links: [
      { rel: "canonical", href: "https://glow.hairqare.co/23-the-haircare-challenge" },
      {
        rel: "preload",
        as: "image",
  ...
  component: HaircareChallengePageV23,
});