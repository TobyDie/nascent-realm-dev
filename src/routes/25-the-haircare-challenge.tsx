...
import { ListiclePageV25 } from "@/features/haircare-challenge-v25/ListiclePageV25";

export const Route = createFileRoute("/25-the-haircare-challenge")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://glow.hairqare.co/25-the-haircare-challenge" },
      ...
      { name: "twitter:url", content: "https://glow.hairqare.co/25-the-haircare-challenge" },
    ],
    links: [
      { rel: "canonical", href: "https://glow.hairqare.co/25-the-haircare-challenge" },
