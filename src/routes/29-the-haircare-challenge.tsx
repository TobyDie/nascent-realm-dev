...
import { ListiclePageV29 } from "@/features/haircare-challenge-v29/ListiclePageV29";

export const Route = createFileRoute("/29-the-haircare-challenge")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://glow.hairqare.co/29-the-haircare-challenge" },
      ...
      { name: "twitter:url", content: "https://glow.hairqare.co/29-the-haircare-challenge" },
    ],
    links: [
      { rel: "canonical", href: "https://glow.hairqare.co/29-the-haircare-challenge" },
