...
import { ListiclePageV24 } from "@/features/haircare-challenge-v24/ListiclePageV24";

export const Route = createFileRoute("/24-the-haircare-challenge")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://glow.hairqare.co/24-the-haircare-challenge" },
      ...
      { name: "twitter:url", content: "https://glow.hairqare.co/24-the-haircare-challenge" },
    ],
    links: [
      { rel: "canonical", href: "https://glow.hairqare.co/24-the-haircare-challenge" },
