...
import { HaircareChallengePageV21 } from "@/features/haircare-challenge-v21/HaircareChallengePageV21";
import { r2img, r2srcset, HERO_WIDTHS } from "@/features/haircare-challenge-v21/img";

const HERO_SIZES = "(max-width: 720px) 100vw, (max-width: 860px) 90vw, 405px";

export const Route = createFileRoute("/21-the-haircare-challenge")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://glow.hairqare.co/21-the-haircare-challenge" },
      ...
      { name: "twitter:url", content: "https://glow.hairqare.co/21-the-haircare-challenge" },
    ],
    links: [
      { rel: "canonical", href: "https://glow.hairqare.co/21-the-haircare-challenge" },
      {
        rel: "preload",
        as: "image",
  ...
  component: HaircareChallengePageV21,
});