...
export function ResultCards() {
  return (
    <section className="v29-band v29-band--white v29-cards">
      <div className="v29-container v29-cards__grid">
        {CARDS.map((c, i) => (
          <article className="v29-rcard" key={i}>
            <div className="v29-rcard__media">
              <Placeholder
                w={600}
                h={600}
                label="Day 14"
            ...
            <div className="v29-rcard__body">
              <div className="v29-rcard__head">
                <strong>{c.name}</strong>
                <span className="v29-rcard__day">{c.day}</span>
              </div>
              <p className="v29-rcard__quote">"{c.quote}"</p>
              <div className="v29-rcard__concerns">
                <span className="v29-rcard__concerns-label">Key Concerns:</span>
                <div className="v29-rcard__tags">
                  {c.tags.map((t) => (
                    <span className="v29-pill" key={t}>{t}</span>
                  ))}
                </div>
              </div>
            </div>
