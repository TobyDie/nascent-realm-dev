...
export function Hero() {
  return (
    <section className="v26-hero" id="hero">
      <div className="v26-hero__media">
        <R2Image
      ...
      <div className="v26-container">
        <div className="v26-hero__copy">
          <span className="v26-trust v26-trust--chip">
          ...
          <h1 className="v26-h1 v26-h1--dual">
            <span className="v26-accent">5 Reasons</span> Women Quit{" "}
            <span className="v26-accent">Buying Shampoo</span> And Started Making It
          </h1>
          <p className="v26-lede">
