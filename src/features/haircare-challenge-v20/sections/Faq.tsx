    ...
    <section className="bg-lav">
      ...
      <div className="wrap" style={{ maxWidth: 760 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {item(5, "I bleach / colour / heat-style my hair. Will this still work for me?", "Yes - and the program is built knowing most of you do. The DIY shampoo and the silicone workshop are specifically designed to let you keep styling without sacrificing the length you're growing. You don't have to give up your colour. You have to stop the damage from compounding.")}
