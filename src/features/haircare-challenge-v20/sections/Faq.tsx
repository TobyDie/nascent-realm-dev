    ...
    <section className="bg-lav">
      ...
      <div className="wrap" style={{ maxWidth: 760 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {item(3, "I've tried so many things. Why is this different?", "Because this isn't another bottle - it's the thing the bottles couldn't give you. Every product you've tried was working on one piece in isolation. This shows you how the pieces fit together, so you stop chasing the next launch and start actually understanding your own hair.")}
          ...
          {item(5, "Can I join from anywhere in the world?", "Yes. The challenge is 100% online and runs in English. Daily videos, the journal, the workshops and the community are all accessible from any country - all you need is a phone or laptop.")}
          {item(6, "Will I have access to the challenge after it's completed?", "Yes - the masterclass, journal, workshops and handbooks are yours to keep forever. You can revisit any lesson, re-run the challenge, or use the reference guides whenever you need them.")}
          {item(7, "Do I need to buy any special products to do this?", "No. Everything in the challenge is built around things you likely already have at home, plus a few inexpensive kitchen ingredients for the DIY shampoo workshop. There is nothing extra to buy from us.")}
          {item(8, "Is this just another course I'll never finish?", "The 14-day structure and the community cohort - everyone starts together - are specifically designed to get you to the finish line. 86% of participants complete the challenge.")}
          {item(9, "Can I get a refund if I don't like it?", "Yes. Your purchase is 100% risk-free with a 30-day money-back guarantee. If the challenge isn't for you, email hello@hairqare.co within 30 days of starting and we'll refund you in full. No questions asked.")}
        </div>
