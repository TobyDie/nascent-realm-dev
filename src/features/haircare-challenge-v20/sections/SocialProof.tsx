...
export function SocialProof({ onCta }: { onCta?: () => void }) {
  ...
  const testimonials: Testi[] = [
    ...
    { name: "Alina Nuno", initials: "A", context: "Shine restoration", text: "My before and after photos were a wake up call! I could see how much length my hair has now compared to when I first joined. It is so much smoother and softer, lighter, fluffier! I am loving the way my hair feels - seeing the marked change reinforces that the work is working!", imageUrl: "https://pub.hairqare.co/SP21/Long-hair-Damage-and-Shine-Before-After.webp" },
    { name: "Brianna Reetz", initials: "B", context: "Split ends · dull, brittle hair", text: "I kept eating what I should be, and just from that, my hair has already changed. It's already becoming a lot thicker, it's already have a bit more shine to it. I trimmed the split ends, and it's already going great. Now my hair is softer and longer.", imageUrl: "https://pub.hairqare.co/SP21/Long-hair-Damage-and-Shine-Before-After-4.webp" },
