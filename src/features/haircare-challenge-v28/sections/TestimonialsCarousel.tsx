...
const TESTIS: Testi[] = [
  ...
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/f19_mena_wavy_20s.webp" },
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/f14_latina_curly.webp" },
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/f12_filipina_straight.webp" },
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/f08_redhead_wavy.webp" },
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/r13_northafrican_curly_20s_pc.webp" },
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/r06_black_relaxed_40s_pc.webp" },
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/r05_black_coily_20s_pc.webp" },
  { name: "", initials: "", context: "", text: "", image: "https://pub.hairqare.co/Merely/f18_black_coily_20s.webp" },
];
...
function Card({ t }: { t: Testi }) {
  return (
    <div className="v28-testis__card">
      ...
      <div className="v28-testis__body">
        <p className="v28-testis__quote">"{t.text}"</p>
        <div className="v28-testis__meta">
          <div className="v28-testis__avatar" aria-hidden="true">{t.initials}</div>
          <div className="v28-testis__who">
            <div className="v28-testis__name">{t.name}</div>
            <div className="v28-testis__ctx">{t.context}</div>
          </div>
          <Stars />
        </div>
      </div>
...
export function TestimonialsCarousel() {
  ...
  return (
    <section className="v28-band v28-band--white v28-testis" id="results">
      <div className="v28-container">
        <h2 className="v28-h2 v28-testis__h">From women whose hair finally kept growing</h2>

        {isMobile ? (
          <>
            <div ref={trackRef} className="v28-testis__track">
              {TESTIS.map((t, i) => (
                <div key={i} className="v28-testis__slide">
                  <Card t={t} />
                </div>
              ))}
            </div>
            <div className="v28-testis__dots">
              {TESTIS.map((_, i) => (
                <button
                  key={i}
                  className={`v28-testis__dot ${i === idx ? "is-on" : ""}`}
                  onClick={() => scrollTo(i)}
          ...
          <div className="v28-testis__grid">
