...
export function ResultCards() {
  return (
    <section className="v28-band v28-band--white v28-cards">
      <div className="v28-container v28-cards__grid">
        {CARDS.map((c, i) => (
          <article className="v28-rcard" key={i}>
            <div className="v28-rcard__media">
              <Placeholder
                w={600}
                h={600}
                label="Day 14"
            ...
            <div className="v28-rcard__body">
              <div className="v28-rcard__head">
                <strong>{c.name}</strong>
                <span className="v28-rcard__day">{c.day}</span>
              </div>
              <p className="v28-rcard__quote">"{c.quote}"</p>
              <div className="v28-rcard__concerns">
                <span className="v28-rcard__concerns-label">Key Concerns:</span>
                <div className="v28-rcard__tags">
                  {c.tags.map((t) => (
                    <span className="v28-pill" key={t}>{t}</span>
                  ))}
                </div>
              </div>
            </div>
