...
export function BottomCta() {
  return (
    <section className="v28-section v28-bottomcta">
      <Marquee
        variant="cta"
        items={[
      ...
      />
      <div className="v28-container v28-cta-wrap v28-cta-wrap--big">
        <CtaButton full>Start the 14-day challenge →</CtaButton>
        <div className="v28-trust-row">
          <span className="v28-trust">
