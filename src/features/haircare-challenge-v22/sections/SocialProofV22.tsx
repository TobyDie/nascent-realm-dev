...
export function SocialProofV22() {
  return (
    <section className="v22-band v22-band--peach v22-sp22">
      <div className="v22-container v22-sp22__inner">
        <div className="v22-sp22__avatars" aria-hidden="true">
          {AVATARS.map((f) => (
            <img
              key={f}
              src={avatarUrl(f)}
          ...
          <span className="v22-sp22__plus">+</span>
        </div>
        ...
        <div className="v22-sp22__stats">
          <div className="v22-sp22__stat">
            <div className="v22-sp22__num">92%</div>
            <p className="v22-sp22__cap">saw results within 14 days</p>
          </div>
          <div className="v22-sp22__divider" aria-hidden="true" />
          <div className="v22-sp22__stat">
            <div className="v22-sp22__num">86%</div>
            <p className="v22-sp22__cap">called it life-changing</p>
          </div>
        </div>
