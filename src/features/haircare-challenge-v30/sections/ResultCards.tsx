...
export function ResultCards() {
  return (
    <section className="v30-band v30-band--white v30-cards">
      <div className="v30-container v30-cards__grid">
        {CARDS.map((c, i) => (
          <article className="v30-rcard" key={i}>
            <div className="v30-rcard__media">
              <Placeholder
                w={600}
                h={600}
                label="Day 14"
            ...
            <div className="v30-rcard__body">
              <div className="v30-rcard__head">
                <strong>{c.name}</strong>
                <span className="v30-rcard__day">{c.day}</span>
              </div>
              <p className="v30-rcard__quote">"{c.quote}"</p>
              <div className="v30-rcard__concerns">
                <span className="v30-rcard__concerns-label">Key Concerns:</span>
                <div className="v30-rcard__tags">
                  {c.tags.map((t) => (
                    <span className="v30-pill" key={t}>{t}</span>
                  ))}
                </div>
              </div>
            </div>
