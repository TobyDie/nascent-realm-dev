...
export function Transition() {
  return (
    <section className="v30-section v30-transition" id="challenge">
      <div className="v30-container v30-transition__imgwrap">
        <R2Image
      ...
      <div className="v30-container v30-transition__inner">
        <div className="v30-eyebrow v30-eyebrow--center">THE WAY OUT</div>
        <h2 className="v30-h2">What If You Never Had To Buy Another "Miracle" Again?</h2>

        <div className="v30-wayout">
          <p className="v30-wayout__lead">Picture your bathroom shelf with nothing on it you regret.</p>

          <ul className="v30-wayout__pains">
            <li className="v30-wayout__pain">
              <span className="v30-wayout__pain-mark" aria-hidden="true"><span /></span>
          ...
          <blockquote className="v30-wayout__reveal">
            Here's the part the industry buried: your hair was never the problem. You were just never taught how it actually works.
          </blockquote>

          <div className="v30-wayout__solution">
            <p>That's the whole challenge. Over 14 days, Sarah shows you what your hair truly needs, from the inside out.</p>
            <p className="v30-wayout__solution-em">Not another product to add to the pile. The understanding that finally lets you stop guessing.</p>
          </div>

          <div className="v30-wayout__result">
            <div className="v30-wayout__result-eyebrow">THE RESULT</div>
            <p>
          ...
          <p className="v30-wayout__founder">
          ...
          <div className="v30-wayout__reassure-wrap">
            <span className="v30-wayout__reassure">You don't have to commit to anything right now.</span>
          </div>

          <p className="v30-wayout__close">
