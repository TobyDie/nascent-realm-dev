...
export function BottomCta() {
  return (
    <section className="v30-section v30-bottomcta">
      <Marquee
        variant="cta"
        items={[
      ...
      />
      <div className="v30-container v30-cta-wrap v30-cta-wrap--big">
        <CtaButton full>Start the 14-day challenge →</CtaButton>
        <div className="v30-trust-row">
          <span className="v30-trust">
